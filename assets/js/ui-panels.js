$(document).ready(function(){
	...
	savequery = function(panelid){
	    ...
	    socket.post('/CypherQuery/create', queryobj, function(){
	...
	toggleSaveEnabled = function(a,b,savepanel,uid){
	...
	createSaveQueryPanel = function (uidOfEditor){
		...
		$(savepanel).find('#name').keyup(function(){
			...
			toggleSaveEnabled(l,l2,savepanel,uid);
		}); 
